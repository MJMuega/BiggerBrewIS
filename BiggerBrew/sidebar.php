...
<div class="side-header">
    <img src="./assets/images/logo.png" width="180" height="180" alt="BiggerBrew"> 
    <h5 style="margin-top:10px;">Bigger Brew</h5>
</div>

<hr style="border:1px solid; background-color:#34282C; border-color:#3B3131;">
